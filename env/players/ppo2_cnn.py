...
ex: python -m gfootball.play_game --players "ppo2_cnn:left_players=1,checkpoint='python -m gfootball.play_game --players "ppo2_cnn:left_players=1,checkpoint='~\Desktop\checkpoint',policy=cnn',policy=cnn"
"""
